...
import {
  UNSAFE_getHydrationData as getHydrationData2,
  UNSAFE_invariant as invariant2,
  UNSAFE_FrameworkContext as FrameworkContext2,
  UNSAFE_decodeViaTurboStream as decodeViaTurboStream,
  UNSAFE_RemixErrorBoundary as RemixErrorBoundary,
  UNSAFE_createBrowserHistory as createBrowserHistory2,
  UNSAFE_createClientRoutes as createClientRoutes,
  UNSAFE_createRouter as createRouter2,
...
function createHydratedRouter({
  ...
  if (ssrInfo.context.isSpaMode) {
    ...
    hydrationData = getHydrationData2({
...
function HydratedRouter(props) {
  ...
  invariant2(ssrInfo, "ssrInfo unavailable for HydratedRouter");
